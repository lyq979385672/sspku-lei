                ...
                <div class="section">
                    <div id="menu2" class="nav-box menuhd">
                        <ul>
                            ...
                            <li class="news">
                                <a href="#" class="">
                                    <span class="out" style="top: 0px;">精品推荐</span>
                                </a>
                            </li>
                            <li class="photo">
                                <a href="#" class="">
                                    <span class="out" style="top: 0px;">减价商品</span>
                                </a>
                            </li>
                            <li class="video">
                                <a href="#" class="">
                                    <span class="out" style="top: 0px;">热点商品</span>
                                </a>
                            </li>
                            <li class="down">
                                <a href="#" class="">
                                    <span class="out" style="top: 0px;">交易须知</span>
                                </a>
                            </li>
                            <li class="goods">
